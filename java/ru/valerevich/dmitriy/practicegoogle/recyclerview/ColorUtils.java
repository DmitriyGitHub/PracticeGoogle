...
/**
 *  Используется для окраски ViewHolders
 */
public class ColorUtils {

    /**
     * Этот метод возвращает соответствующий оттенок зеленого цвета в виде градиента
     * в списке.
     * Этот метод используется, чтобы показать, как ViewHolders перерабатываются в RecyclerView.
     */
